...
_SCREEN_3 = [
    ...
    '0000000000000000000000000',
    '0000000000000000000000000',
    '00000S0000000000000000000',
    '1111111000000000000000000',
]

LEVEL_1 = []
for i in range(len(_SCREEN_1)):
    LEVEL_1.append(_SCREEN_1[i] + _SCREEN_2[i] + _SCREEN_3[i])